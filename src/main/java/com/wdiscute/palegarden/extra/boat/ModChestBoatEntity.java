package com.wdiscute.palegarden.extra.boat;

import com.wdiscute.palegarden.ModItems;
...
public class ModChestBoatEntity extends ChestBoat
{
    ...
    {
        this(ModEntities.PALE_OAK_CHEST_BOAT.get(), pLevel);
    ...
    public Item getDropItem()
    {
        return switch (getModVariant()) {
            case PALE_OAK -> ModItems.PALE_OAK_CHEST_BOAT.get();
        };
    }
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder)
    {
        ...
        builder.define(DATA_ID_TYPE, ModBoatEntity.Type.PALE_OAK.ordinal());
    }
